...
export const STORY_TITLE = "Gió lạnh đầu mùa";
export const AUTHOR = "Thạch Lam";

export const STORY_CONTENT = `Buổi sáng hôm nay, mùa đông đột nhiên đến, không báo trước. Vừa mới ngày hôm qua giời hãy còn nắng ấm và hanh, cái nắng về cuối tháng mười làm nứt nẻ đất ruộng, và làm giòn khô những chiếc lá rơi. Sơn và chị chơi cỏ gà ở ngoài cánh đồng còn thấy nóng bức, chảy mồ hôi.
...
Đến cuối chợ đã thấy lũ trẻ đang quây quản chơi nghịch. Chúng nó thấy chị em Sơn đến đều lộ vẻ vui mừng, nhưng chúng vẫn đứng xa, không dám vồ vập. Chúng như biết cái phận nghèo hèn của chúng vậy, tuy Sơn và chị vẫn thân mật chơi đùa với, chứ không kiêu kỳ và khinh khỉnh như các em họ của Sơn.
